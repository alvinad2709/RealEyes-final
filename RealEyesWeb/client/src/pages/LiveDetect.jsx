...
export default function LiveDetect() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
       {/* Tracker Viewport */}
       ...
       {/* Control Panel */}
       <div className="glass-panel p-6 border border-deepBorder flex flex-col justify-between">
